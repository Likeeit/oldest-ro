...
#define MAX_PARTY 12
#define MAX_GUILD (6+10*1)     // Increased max guild members +6 per 1 extension levels [Lupus]
#define MAX_GUILDPOSITION 16    // Increased max guild positions to accomodate for all members [Valaris] (removed) [PoW]
